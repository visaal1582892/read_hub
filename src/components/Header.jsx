...
const Header = () => {
  return (
    <header className='bg-blue-500 text-white p-4 flex justify-center items-center w-screen place-items-center place-content-center h-[13vh] overflow-x-hidden'>
