...
import { setBook } from '../utils/bookSlice';
...
const BookCard = (props) => {
  ...
  return (
    <article className='flex flex-col items-center justify-between rounded-md shadow-lg shadow-gray-200 basis-40 h-60 grow-0 shrink-0 snap-center snap-always bg-white border-2 border-blue-500 hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer' onClick={handleClick}>
